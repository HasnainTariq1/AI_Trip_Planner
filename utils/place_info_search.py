...
class GooglePlaceSearchTool:
    ...
    def google_search_attractions(self, place: str) -> dict:
        """
        Searches for attraction in the specified place using GooglePaces API. 
        """
        return self.places_tool.run(f"top attractive places in and around {place}")
    
    def google_search_restaurants(self, place: str) -> dict:
        """
        Searches for available restaurants in the specified place using GooglePaces API. 
        """
    ...
    def google_search_activity(self, place: str) -> dict:
        """
        Searches for popular activities in the specified place using GooglePaces API. 
        """
    ...
    def google_search_transportation(self, place: str) -> dict:
        """
        Searches for available modes of transportation in the specified place using GooglePaces API. 
        """
